                ...
                <tr key={order.orderId} className="border-b border-gray-200">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                    {order.status === 0 ? (
                      ...
                      <span className="text-xs font-semibold px-2 py-1 rounded text-red-600 bg-red-100">Failed</span>
                    ) : (
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-md shadow-lg">
            <p className="text-lg font-semibold mb-4">Bạn có chắc chắn muốn hủy đơn hàng?</p>
