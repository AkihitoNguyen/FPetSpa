...
export default function ProductList() {
  ...
  const handleSearchResultSelect = (result) => {
    const filteredProduct = productList.find(
      (product) => product.productName === result.title
    );
    if (filteredProduct) {
                  ...
                  <div className="mx-auto max-w-2xl py-16 px-4 sm:py-20 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        currentProducts.map((product) => (
                          <div
                            ...
                            <div className="relative pb-5/4">
                              {product?.productName ? (
                                <Link
                                  to={`/productdisplay/${product.productName}`}>
                                  <img
                            ...
                            <div className="p-2 flex flex-col flex-grow justify-between">
                              ...
                              <div className="flex justify-between items-center mt-3">
                                <span className="ordernow-text text-[#d13a3a] font-semibold group-hover:text-gray-800">
                                  ${product?.price}
                                </span>
                                <button
                    ...
                    <div className="mt-6 flex justify-center">
                      <ul className="flex">
                        {Array.from({
                          length: Math.ceil(
                            sortedProductList.length / productsPerPage
                          ),
                        }).map((_, index) => (
                          <li key={index}>
                            <button
