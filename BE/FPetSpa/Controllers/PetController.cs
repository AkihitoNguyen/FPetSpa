...
namespace FPetSpa.Controllers
{
    ...
    public class PetController : ControllerBase
    {
            ...
            if(responseCategories != null) 
                ...
                if (image != null)
                {
                    return Ok(new Pet
                    {
                        ...
                        PetType = responseCategories.PetType,
        ...
        public async Task<IActionResult> UpdatePet(string id, RequestCreatePetModel requestCreatePetModel)
        {
            ...
            if (existedPet != null)
            {
               if(existedPet.CustomerId != null) existedPet.CustomerId = requestCreatePetModel.CustomerId;
                if(existedPet.PetName != null) existedPet.PetName = requestCreatePetModel.PetName;
                if (existedPet.PictureName != null)
                {
                   ...
                   if(existedPet.PetType != null) existedPet.PetType = requestCreatePetModel.PetType;
                if(existedPet.PetWeight != null)existedPet.PetWeight = requestCreatePetModel.PetWeight;
